...
import {ReactComponent as Dollar } from '../images/svg/credit.svg'
        ...
        <div className="Transactions-item">
            <div className="Transactions-item-left">
                <div 
                    ...
                    {
                        category === 'rent'
                        ? <Rent className='Transactions-item-svg icon-rent' />
                        : category === 'shopping'
                        ? <Shopping className='Transactions-item-svg icon-shopping' />
                        : category === 'food'
                        ? <Food className='Transactions-item-svg icon-food' />
                        : category === 'entertainment'
                        ? <Entertainment className='Transactions-item-svg icon-food' />
                        : <Dollar className='Transactions-item-svg icon-dollar' />
                    }
